...
| **jmo/jno&nbsp;[Lable]** | команда условного перехода. Переход происходит если установлен / не установлен флаг `FO` |
...
| **split&nbsp;[dir]&nbsp;[Lable]** | команда деления. Бот, если у него достаточно энергии, создает свою копию в указанном направлении. Копия начинает выполнение кода с указанной метки. Копия наследует направление взгляда и значения регистров общего назначения |
| **fork&nbsp;[dir]&nbsp;[Lable]** | аналогична команде `split`, но при копировании с небольшим шансом может возникнуть мутация. Также новый бот создает собственную колонию |
