...
| **jge/jle&nbsp;[Lable]** | команда условного перехода. Переход происходит если установлен флаг `FE` или установлен / не установлен флаг `FS` |
...
| **cmp&nbsp;[reg]&nbsp;[reg]** | команда выполнения проверки. <br> cmp a b <br> a > b => `FS` = 1 <br> a < b => `FS` = 0 <br> a == b => `FZ` = 1 <br> a != b => `FZ` = 0  |
