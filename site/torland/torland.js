...
const WorldWraperFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_worldwraper_free(ptr >>> 0, 1));

export class WorldWraper {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WorldWraper.prototype);
        obj.__wbg_ptr = ptr;
        WorldWraperFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WorldWraperFinalization.unregister(this);
        return ptr;
    }
    ...
    static new(cfg) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.worldwraper_new(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            ...
            return WorldWraper.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    update() {
        wasm.worldwraper_update(this.__wbg_ptr);
    }
    /**
    ...
    get_bot(x, y) {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.worldwraper_get_bot(retptr, this.__wbg_ptr, x, y);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('torland_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
